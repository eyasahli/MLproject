...
from src.components.utils import save_file
...
class DataTransformation:
    ...
    def get_data_transformer_object(self): #create all pickle files of the preprocessing
        '''
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_file(
                file_path=self.DataConfig.preprocessor_obj_file_path,
                obj=preprocessing_obj
            )
            
            return (
                train_arr,test_arr,self.DataConfig.preprocessor_obj_file_path
            )  
